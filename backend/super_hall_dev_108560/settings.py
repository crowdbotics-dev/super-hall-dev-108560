"""
Django settings for super_hall_dev_108560 project.
...
ROOT_URLCONF = 'super_hall_dev_108560.urls'
...
WSGI_APPLICATION = 'super_hall_dev_108560.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_hall_dev_108560 API",
    "DESCRIPTION": "API documentation for super_hall_dev_108560 App",
    "VERSION": "v1",
}
